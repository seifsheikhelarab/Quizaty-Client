...
export async function clientLoader() {
  // We can fetch critical data synchronously and defer the rest
  // For now, let's fetch everything and see if we can defer some parts
...
export default function TeacherDashboard({ loaderData }: Route.ComponentProps) {
  const { stats, subscription, limits, planInfo, usage } = loaderData as StatsData;
